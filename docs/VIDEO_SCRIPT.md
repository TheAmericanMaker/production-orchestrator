...
**Length:** target **4:00**, hard cap 5:00 (rules). **Language:** English. **Host:** public YouTube or Vimeo.
**Frame:** the trust problem first, then the proof. Hero claim: *zero unapproved writes — provably fail-closed under forged, stale, and replayed inputs, across a real process boundary.*
